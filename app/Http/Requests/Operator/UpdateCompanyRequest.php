...
class UpdateCompanyRequest extends FormRequest
{
    ...
    {
        // Operator must already have a company to update it
        return $this->user() && (bool) $this->user()->company;
    }
    ...
    {
        abort(404, 'No company found. Please create a company profile first.');
    }
}
