                    ...
                    <td class="p-4 text-right">
                        <div class="flex items-center justify-end gap-2">
                            ...
                            <select
                                ...
                                class="text-xs border border-gray-200 rounded-lg px-2 py-1.5 bg-white text-gray-600 focus:outline-none focus:ring-1 focus:ring-indigo-400 disabled:opacity-50"
                                title="Change Role"
                            >
                            ...
                            >
                                <svg v-if="actionLoadingId === user.id" class="w-4 h-4 animate-spin text-gray-400" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"/></svg>
                                <svg v-else-if="user.status === 'active'" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"/></svg>
                            ...
                            <!-- Edit Full Profile -->
                            <router-link :to="{ name: 'admin-users-edit', params: { id: user.id } }" class="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg border border-transparent transition-colors" title="Edit User">
