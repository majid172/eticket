...
const menuItems = [
  ...
  { name: 'Companies',      path: '/admin/companies',      icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-2 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
  { name: 'Subscriptions',  path: '/admin/subscriptions',  icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' },
    ...
    <div class="flex-grow flex flex-col h-full overflow-hidden w-full relative">
      ...
      <header class="h-20 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-8 z-20 sticky top-0">
        ...
        <div class="flex items-center space-x-6">
             ...
             <!-- View Website Button -->
             <a href="/" target="_blank" class="hidden md:flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-600 rounded-full hover:bg-emerald-100 transition-colors text-sm font-medium transform hover:scale-105 duration-200">
             ...
             <!-- Settings -->
             <RouterLink to="/admin/settings" class="text-slate-400 hover:text-slate-700 transition-colors">
